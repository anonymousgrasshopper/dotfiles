return {
	{
		...
		config = function()
			require("nvim-treesitter.configs").setup({
				highlight = {
					enable = true,
					disable = function() return vim.tbl_contains({ "tex", "markdown", "checkhealth" }, vim.bo.filetype) end,
					-- disable = { "tex", "markdown", "checkhealth" }, -- doesn't work for checkhealth for some reason
				},
				indent = { enable = true },
				ensure_installed = {
					"c",
