return {
	...
	},
	{
		...
		ft = "qf",
		keys = {
			{ "]q", "<Plug>(qf_qf_previous)zz", desc = "Next quickfix entry" },
			{ "[q", "<Plug>(qf_qf_next)zz", desc = "Previous quickfix entry" },
			{ "]Q", "<Plug>(qf_loc_previous)zz", desc = "Next location list entry" },
			{ "[Q", "<Plug>(qf_loc_next)zz", desc = "Previous location list entry" },
