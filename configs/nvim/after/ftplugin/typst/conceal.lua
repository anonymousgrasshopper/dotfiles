...
-- Toggle hiding of extmarks on the current line
-- Works for virtual text and highlights
-- Toggle hiding of extmarks on the current line for a specific namespace
-- Cache for hidden extmarks
