...
#define id(x) cerr << #x << " : \n=======\n";
#define n(x) for (int i=0;i<x;i++) cerr << '\n';
...
#define dbg2(x,y) cerr << #x << " = " << dbg_format(x) << '\n'; cerr << #y << " = " << dbg_format(y) << '\n'; 
#define dbg3(x,y,z) cerr << #x << " = " << dbg_format(x) << '\n'; cerr << #y << " = " << dbg_format(y) << '\n'; cerr << #z << " = " << dbg_format(z) << '\n'; 
#define dbg4(x,y,z,w) cerr << #x << " = " << dbg_format(x) << '\n'; cerr << #y << " = " << dbg_format(y) << '\n'; cerr << #z << " = " << dbg_format(z) << '\n'; cerr << #w << " = " << dbg_format(w) << '\n'; 
...
#define dbgarr1(x) cerr << #x << " :\n=======\n"; for(auto y:x) cerr << dbg_format(y) << " "; cerr<<'\n';
#define dbgarr2(a,n) cerr << #a <<" :\n=======\n"; for (int i=0;i<n;i++) cerr<<dbg_format(a[i])<<" "; cerr<<'\n';
