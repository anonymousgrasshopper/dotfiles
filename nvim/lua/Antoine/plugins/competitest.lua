	...
	config = function()
		require("competitest").setup({
			...
			compile_command = {
				...
				cpp = { exec = "g++", args = { "-Wall", "-Wextra", "-Wno-sign-compare", "-pedantic", "-std=c++11", "-O2", "$(FNAME)", "-o", "$(FNOEXT).exe", "-Wshadow", "-Wformat=2", "-Wfloat-equal", "-Wlogical-op", "-Wshift-overflow=2", "-Wduplicated-cond", "-Wcast-qual", "-Wcast-align", "-D_GLIBCXX_DEBUG", "-D_GLIBCXX_DEBUG_PEDANTIC", "-D_FORTIFY_SOURCE=2", "-fsanitize=address", "-fsanitize=undefined", "-fno-sanitize-recover", "-fstack-protector", "$(FNAME)", "-o", "$(FNOEXT).exe" } },
